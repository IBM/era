...
void updateBounds(Observation* obs_ptr, float* data, unsigned int data_size, double robot_x, double robot_y,
                ...
                struct timeval* ocgr_upBd_total_start_cp, size_t ocgr_upBd_total_start_cp_sz,
                struct timeval* ocgr_upBd_rayFSp_stop_cp, size_t ocgr_upBd_rayFSp_stop_cp_sz,
                uint64_t* ocgr_upBd_rayFSp_sec_cp, size_t ocgr_upBd_rayFSp_sec_cp_sz,
                uint64_t* ocgr_upBd_rayFSp_usec_cp, size_t ocgr_upBd_rayFSp_usec_cp_sz,
                struct timeval* ocgr_upBd_total_stop_cp, size_t ocgr_upBd_total_stop_cp_sz,
                uint64_t* ocgr_upBd_regObst_sec_cp, size_t ocgr_upBd_regObst_sec_cp_sz,
                uint64_t* ocgr_upBd_regObst_usec_cp, size_t ocgr_upBd_regObst_usec_cp_sz,
                uint64_t* ocgr_upBd_total_sec_cp, size_t ocgr_upBd_total_sec_cp_sz,
                uint64_t* ocgr_upBd_total_usec_cp, size_t ocgr_upBd_total_usec_cp_sz);
...
void cloudToOccgrid_impl(Observation * obs_ptr, size_t obs_ptr_sz,
                ...
                struct timeval* ocgr_upBd_total_start_cp, size_t ocgr_upBd_total_start_cp_sz /*=sizeof(struct timeval)*/,
                struct timeval* ocgr_upBd_total_stop_cp, size_t ocgr_upBd_total_stop_cp_sz /*=sizeof(struct timeval)*/,
                uint64_t* ocgr_upBd_total_sec_cp, size_t ocgr_upBd_total_sec_cp_sz /*=sizeof(uint64_t)*/,
                uint64_t* ocgr_upBd_total_usec_cp, size_t ocgr_upBd_total_usec_cp_sz /*=sizeof(uint64_t)*/,

                struct timeval* ocgr_upBd_rayFSp_start_cp, size_t ocgr_upBd_rayFSp_start_cp_sz /*=sizeof(struct timeval)*/,
                struct timeval* ocgr_upBd_rayFSp_stop_cp, size_t ocgr_upBd_rayFSp_stop_cp_sz /*=sizeof(struct timeval)*/,
                uint64_t* ocgr_upBd_rayFSp_sec_cp, size_t ocgr_upBd_rayFSp_sec_cp_sz /*=sizeof(uint64_t)*/,
                uint64_t* ocgr_upBd_rayFSp_usec_cp, size_t ocgr_upBd_rayFSp_usec_cp_sz /*=sizeof(uint64_t)*/,

                struct timeval* ocgr_upBd_regObst_start_cp, size_t ocgr_upBd_regObst_start_cp_sz /*=sizeof(struct timeval)*/,
                struct timeval* ocgr_upBd_regObst_stop_cp, size_t ocgr_upBd_regObst_stop_cp_sz /*=sizeof(struct timeval)*/,
                uint64_t* ocgr_upBd_regObst_sec_cp, size_t ocgr_upBd_regObst_sec_cp_sz /*=sizeof(uint64_t)*/,
                uint64_t* ocgr_upBd_regObst_usec_cp, size_t ocgr_upBd_regObst_usec_cp_sz /*=sizeof(uint64_t)*/
...
void cloudToOccgrid(Observation * obs_ptr, size_t obs_ptr_sz,
                ...
                // End of global variables used for timing sections of cloudToOccgrid
                        ...
                        void * timer_start = __hetero_task_begin(2, ocgr_c2g_total_start_cp, ocgr_c2g_total_start_cp_sz,
                                        timer_sequentialize, timer_sequentialize_sz,
                                        2, ocgr_c2g_total_start_cp, ocgr_c2g_total_start_cp_sz,
                                        timer_sequentialize, timer_sequentialize_sz);
#endif
#ifdef INT_TIME
                        *timer_sequentialize = 1;
                        gettimeofday(ocgr_c2g_total_start_cp, NULL);
#endif
#if defined(HPVM) && true
                        __hetero_task_end(timer_start);
#endif

#if defined(HPVM) && true
                        void * cloudToOccgrid_impl_task = __hetero_task_begin(35,
                                        ...
                                        // The following argument is used to ensure that task wrapping call to start timer occurs before the call to
                                        // return ending time after time section of code completes.
                                        timer_sequentialize, timer_sequentialize,
                                        // Outputs
                                        31, obs_ptr, obs_ptr_sz, lidar_inputs, lidar_inputs_sz,
...
#if defined(HPVM) && true
                        void * timer_end = __hetero_task_begin(5, ocgr_c2g_total_start_cp, ocgr_c2g_total_start_cp_sz,
                                        ocgr_c2g_total_stop_cp, ocgr_c2g_total_stop_cp_sz,
                                        ocgr_c2g_total_sec_cp, ocgr_c2g_total_sec_cp_sz,
                                        ocgr_c2g_total_usec_cp, ocgr_c2g_total_usec_cp_sz,
                                        timer_sequentialize, timer_sequentialize_sz,
                                        5, ocgr_c2g_total_start_cp, ocgr_c2g_total_start_cp_sz,
                                        ocgr_c2g_total_stop_cp, ocgr_c2g_total_stop_cp_sz,
                                        ocgr_c2g_total_sec_cp, ocgr_c2g_total_sec_cp_sz,
                                        ocgr_c2g_total_usec_cp, ocgr_c2g_total_usec_cp_sz,
                                        timer_sequentialize, timer_sequentialize_sz);
                        ...
                        *timer_sequentialize = 3;
                        gettimeofday(ocgr_c2g_total_stop_cp, NULL);
                        *ocgr_c2g_total_sec_cp  += ocgr_c2g_total_stop_cp->tv_sec  - ocgr_c2g_total_start_cp->tv_sec;
                        *ocgr_c2g_total_usec_cp += ocgr_c2g_total_stop_cp->tv_usec - ocgr_c2g_total_start_cp->tv_usec;
#endif
#if defined(HPVM) && true
                        __hetero_task_end(timer_end);
                        __hetero_section_end(Section);
#endif
                }

// Note: We want to measure the total time this function takes. However, we can't achieve that placing a start and end
// timer call inside this function (as those calls will end up being parallelized with tasks within this function).
// The caller of this function must measure the time this function takes.
void cloudToOccgrid_impl(Observation * obs_ptr, size_t obs_ptr_sz,
                lidar_inputs_t* lidar_inputs, size_t lidar_inputs_sz /*=sizeof(*lidar_inputs*/,
                double* robot_yaw, size_t robot_yaw_sz /*=sizeof(double)*/,
                bool* rolling_window, size_t rolling_window_sz /*=sizeof(bool)*/,
                ...
                // End of global variables used for timing sections of cloudToOccgrid
...
#if defined(HPVM) && true
                        void * T1  = __hetero_task_begin(13, obs_ptr, obs_ptr_sz, lidar_inputs, lidar_inputs_sz,
                                        ...
                                        x_dim, x_dim_sz, y_dim, y_dim_sz, resolution, resolution_sz,
                                        ocgr_c2g_initCM_start_cp, ocgr_c2g_initCM_start_cp_sz, ocgr_c2g_initCM_stop_cp, ocgr_c2g_initCM_stop_cp_sz,
                                        ocgr_c2g_initCM_sec_cp, ocgr_c2g_initCM_sec_cp_sz, ocgr_c2g_initCM_usec_cp, ocgr_c2g_initCM_usec_cp_sz,
                                        1,  obs_ptr, obs_ptr_sz, "initCostmap_task");
#endif
                        {
#ifdef INT_TIME
                                // gettimeofday(&ocgr_c2g_total_start, NULL); // See note above this function for why this call was commented out
                                gettimeofday(ocgr_c2g_initCM_start_cp, NULL);
#endif
...
#ifdef INT_TIME
                                gettimeofday(ocgr_c2g_initCM_stop_cp, NULL);
                                *ocgr_c2g_initCM_sec_cp  += ocgr_c2g_initCM_stop_cp->tv_sec  - ocgr_c2g_initCM_start_cp->tv_sec;
                                *ocgr_c2g_initCM_usec_cp += ocgr_c2g_initCM_stop_cp->tv_usec - ocgr_c2g_initCM_start_cp->tv_usec;
#endif
                        }
#if defined(HPVM) && true
...
#if defined(HPVM) && true
                        void * T2 = __hetero_task_begin(6, obs_ptr, obs_ptr_sz, lidar_inputs, lidar_inputs_sz,
                                        ocgr_c2g_updOrig_start_cp, ocgr_c2g_updOrig_start_cp_sz, ocgr_c2g_updOrig_stop_cp, ocgr_c2g_updOrig_stop_cp_sz,
                                        ocgr_c2g_updOrig_sec_cp, ocgr_c2g_updOrig_sec_cp_sz, ocgr_c2g_updOrig_usec_cp, ocgr_c2g_updOrig_usec_cp_sz,
                                        1, obs_ptr, obs_ptr_sz, "updateOrigin_task");
#endif

                        {
#ifdef INT_TIME
                                gettimeofday(ocgr_c2g_updOrig_start_cp, NULL);
#endif
...
#ifdef INT_TIME
                                gettimeofday(ocgr_c2g_updOrig_stop_cp, NULL);
                                *ocgr_c2g_updOrig_sec_cp  += ocgr_c2g_updOrig_stop_cp->tv_sec  - ocgr_c2g_updOrig_start_cp->tv_sec;
                                *ocgr_c2g_updOrig_usec_cp += ocgr_c2g_updOrig_stop_cp->tv_usec - ocgr_c2g_updOrig_start_cp->tv_usec;
#endif
                        }
#if defined(HPVM) && true
...
#if defined(HPVM) && true
                        void * T3 = __hetero_task_begin(16, obs_ptr, obs_ptr_sz, lidar_inputs, lidar_inputs_sz,
                                        robot_yaw, robot_yaw_sz, 
										ocgr_c2g_updBnds_start_cp, ocgr_c2g_updBnds_start_cp_sz,
										ocgr_c2g_updBnds_stop_cp, ocgr_c2g_updBnds_stop_cp_sz,
										ocgr_c2g_updBnds_sec_cp, ocgr_c2g_updBnds_sec_cp_sz,
										ocgr_c2g_updBnds_usec_cp, ocgr_c2g_updBnds_usec_cp_sz,
                                        ocgr_upBd_total_start_cp, ocgr_upBd_total_start_cp_sz,
                                        ocgr_upBd_rayFSp_stop_cp, ocgr_upBd_rayFSp_stop_cp_sz,
                                        ocgr_upBd_rayFSp_sec_cp, ocgr_upBd_rayFSp_sec_cp_sz,
                                        ocgr_upBd_rayFSp_usec_cp, ocgr_upBd_rayFSp_usec_cp_sz,
                                        ocgr_upBd_total_stop_cp, ocgr_upBd_total_stop_cp_sz,
                                        ocgr_upBd_regObst_sec_cp, ocgr_upBd_regObst_sec_cp_sz,
                                        ocgr_upBd_regObst_usec_cp, ocgr_upBd_regObst_usec_cp_sz,
                                        ocgr_upBd_total_sec_cp, ocgr_upBd_total_sec_cp_sz,
                                        ocgr_upBd_total_usec_cp, ocgr_upBd_total_usec_cp_sz,
										15, obs_ptr, obs_ptr_sz, lidar_inputs, lidar_inputs_sz, 
										ocgr_c2g_updBnds_start_cp, ocgr_c2g_updBnds_start_cp_sz,
										ocgr_c2g_updBnds_stop_cp, ocgr_c2g_updBnds_stop_cp_sz,
										ocgr_c2g_updBnds_sec_cp, ocgr_c2g_updBnds_sec_cp_sz,
										ocgr_c2g_updBnds_usec_cp, ocgr_c2g_updBnds_usec_cp_sz,
                        ...
                        {
#ifdef INT_TIME
                                gettimeofday(ocgr_c2g_updBnds_start_cp, NULL);
#endif
                                double robot_x = lidar_inputs->odometry[0];
                                double robot_y = lidar_inputs->odometry[1];
                                double robot_z = lidar_inputs->odometry[2];
                                ...
                                //printMap();
#ifdef INT_TIME
                                gettimeofday(ocgr_c2g_updBnds_stop_cp, NULL);
                                *ocgr_c2g_updBnds_sec_cp  += ocgr_c2g_updBnds_stop_cp->tv_sec  - ocgr_c2g_updBnds_start_cp->tv_sec;
                                *ocgr_c2g_updBnds_usec_cp += ocgr_c2g_updBnds_stop_cp->tv_usec - ocgr_c2g_updBnds_start_cp->tv_usec;
...
#ifdef INT_TIME
        gettimeofday(ocgr_upBd_total_start_cp, NULL);
#endif
        //raytrace free space
...
#ifdef INT_TIME
        gettimeofday(ocgr_upBd_rayFSp_stop_cp, NULL);
        *ocgr_upBd_rayFSp_sec_cp  += ocgr_upBd_rayFSp_stop_cp->tv_sec  - ocgr_upBd_total_start_cp->tv_sec;
        *ocgr_upBd_rayFSp_usec_cp += ocgr_upBd_rayFSp_stop_cp->tv_usec - ocgr_upBd_total_start_cp->tv_usec;
#endif
...
#ifdef INT_TIME
        gettimeofday(ocgr_upBd_total_stop_cp, NULL);
        *ocgr_upBd_regObst_sec_cp  += ocgr_upBd_total_stop_cp->tv_sec  - ocgr_upBd_rayFSp_stop_cp->tv_sec;
        *ocgr_upBd_regObst_usec_cp += ocgr_upBd_total_stop_cp->tv_usec - ocgr_upBd_rayFSp_stop_cp->tv_usec;

        *ocgr_upBd_total_sec_cp  += ocgr_upBd_total_stop_cp->tv_sec  - ocgr_upBd_total_start_cp->tv_sec;
        *ocgr_upBd_total_usec_cp += ocgr_upBd_total_stop_cp->tv_usec - ocgr_upBd_total_start_cp->tv_usec;
#endif
}
