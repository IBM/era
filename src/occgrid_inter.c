...
void cloudToOccgrid(Observation * obs_ptr, size_t obs_ptr_sz,
...
#if defined(HPVM) && true
	void * T2 = __hetero_task_begin(2, obs_ptr, obs_ptr_sz, lidar_inputs, lidar_inputs_sz, 1, obs_ptr, obs_ptr_sz, "updateOrigin_task");
#endif
	...
	void * T3 = __hetero_task_begin(3, obs_ptr, obs_ptr_sz, lidar_inputs, lidar_inputs_sz, 
			robot_yaw, robot_yaw_sz, 2, obs_ptr, obs_ptr_sz, lidar_inputs, lidar_inputs_sz, "updateBounds_task");
#endif
